...
policy_model = AutoModelForCausalLMWithValueHead.from_pretrained(policy_checkpoint)
...
reference_model = AutoModelForCausalLM.from_pretrained(policy_checkpoint)
...
dataset = ToneConversionDataset(
    "multitask_data-tone_conversion_v4_train.jsonl",
    policy_tokenizer
)
...
ppo_trainer = PPOTrainer(
    args = ppo_config, model = policy_model, ref_model = reference_model, processing_class = policy_tokenizer, reward_model=reward_model, train_dataset=dataset
)
